...
@Component({
  selector: 'ngx-devices-dragger',
  templateUrl: './devices-dragger.component.html',
  styleUrls: ['./devices-dragger.component.scss'],
})
export class DevicesDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = DevicesDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
